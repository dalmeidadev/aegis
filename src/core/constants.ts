...
import { ErrorVerb, ErrorConfig } from './types';
...
export const DEFAULT_ERROR_MESSAGES: { [key in ErrorVerb]: string } = {
  ...
  'bad-request': 'The request contains invalid data. Please review and try again.',
  'server-error': 'We are having trouble connecting to the server. Please try again later.',
  'network-error': 'Unable to connect to the server. Please check your internet connection.',
  'timeout': 'The request has taken too long. Please try again.',
  'conflict': 'The request could not be completed due to a conflict with the current state of the resource.',
  'too-many-requests': 'You have exceeded the allowed number of requests. Please wait a moment before trying again.',
  'unprocessable-entity': 'The request could not be processed due to invalid data.',
 ...
 */
export const DEFAULT_ERROR_SEVERITIES: { [key in ErrorVerb]: ErrorConfig['severity'] } = {
  'not-found': 'warning',
 ...
 */
export const DEFAULT_ERROR_CONFIGS: { [key in ErrorVerb]: ErrorConfig } = Object.entries(DEFAULT_ERROR_MESSAGES)
